...
export class TrackingController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Course tracking data retrieved successfully',
  })
  ...
  @ApiOperation({
    summary: 'Start a new lesson attempt or get existing incomplete attempt',
  })
  @ApiResponse({
    status: 201,
    description: 'Lesson attempt started or retrieved',
  })
  ...
  @ApiParam({
    name: 'action',
    enum: ['start', 'resume'],
    description: 'Action to perform on the attempt',
  })
  @ApiResponse({
    status: 200,
    description: 'Lesson attempt managed successfully',
  })
  ...
  @ApiParam({
    name: 'eventId',
    description: 'The event ID that maps to lesson.media.source',
    type: 'string',
  })
  @ApiBody({ type: UpdateEventProgressDto })
  @ApiResponse({
    status: 200,
    description: 'Lesson attempt marked as completed successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Lesson not found for the given event ID',
  })
  @ApiResponse({ status: 400, description: 'Invalid request data' })
